...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var fmListArry = [[String: String]]()
    var fmLanguageArry = [[String: String]]()
...
fmListTableView.register(UINib(nibName: "FMListViewCell", bundle: nil), forCellReuseIdentifier: "FMListViewCell")

//http://prasarbharati.gov.in/liveradio.php
        
        
fmLanguageArry.append(["fmLanguage":"Hindi"])
fmLanguageArry.append(["fmLanguage":"Punjabi"])
        
        

fmListArry.append(["fmName": "AIR Live News 24x7", "fmFrequency": "100 FM", "fmLocation":"All INDIA", "fmURL":"http://esdcdn2-lh.akamaihd.net/i/esdcdn2_1@528073/master.m3u8"])
fmListArry.append(["fmName": "Vividh Bharati", "fmFrequency": "102 FM", "fmLocation":"All INDIA", "fmURL":"http://vividhbharati-lh.akamaihd.net/i/vividhbharati_1@507811/master.m3u8"])
fmListArry.append(["fmName": "FM Gold", "fmFrequency": "90 FM", "fmLocation":"Delhi", "fmURL":"http://airfmgold-lh.akamaihd.net/i/fmgold_1@507591/master.m3u8"])
fmListArry.append(["fmName": "FM Rainbow", "fmFrequency": "103 FM", "fmLocation":"Delhi", "fmURL":"http://fmrainbow-lh.akamaihd.net/i/fmrainbow_1@507812/master.m3u8"])
fmListArry.append(["fmName": "Radio Mirchi", "fmFrequency": "98.3 FM", "fmLocation":"Jaipur", "fmURL":"http://peridot.streamguys.com:7150/Mirchi"])
fmListArry.append(["fmName": "Radio City", "fmFrequency": "91.1 FM", "fmLocation":"All INDIA", "fmURL":"http://prclive1.listenon.in:9960/"])
fmListArry.append(["fmName": "Red FM", "fmFrequency": "93.5 FM", "fmLocation":"Jaipur", "fmURL":"http://14013.live.streamtheworld.com/CKYRFM_SC"])
fmListArry.append(["fmName": "BIG FM", "fmFrequency": "92.7 FM", "fmLocation":"Jaipur", "fmURL":"http://sc-bb.1.fm:8017/"])
fmListArry.append(["fmName": "Radio Selfie", "fmFrequency": "90.8 FM", "fmLocation":"Jaipur", "fmURL":"https://streams.radio.co/s69032f19e/listen"])
fmListArry.append(["fmName": "Raagam", "fmFrequency": "100.1", "fmLocation":"All INDIA", "fmURL":"http://airraagam-lh.akamaihd.net/i/airraagam_1@507820/master.m3u8"])
        
        
fmListArry.append(["fmName": "Radio Punjabi Virsa", "fmFrequency": "55.8 FM", "fmLocation":"Chandigarh", "fmURL":"http://node-13.zeno.fm/25h82wv629duv?rj-ttl=5&rj-token=AAABbH9yGXzSqOSeg6AN-pZ--oR0fjYM5qDKHxsqurjP2Eq5K9EEgA"])
fmListArry.append(["fmName": "AIR Punjabi", "fmFrequency": "90.4 FM", "fmLocation":"Amritsar", "fmURL":"http://airpunjabi-lh.akamaihd.net/i/airpunjabi_1@507822/master.m3u8"])

//fmListArry.append(["fmName": "", "fmFrequency": "", "fmLocation":"", "fmURL":""])
//fmListArry.append(["fmName": "", "fmFrequency": "", "fmLocation":"", "fmURL":""])
//fmListArry.append(["fmName": "", "fmFrequency": "", "fmLocation":"", "fmURL":""])
//fmListArry.append(["fmName": "", "fmFrequency": "", "fmLocation":"", "fmURL":""])
//fmListArry.append(["fmName": "", "fmFrequency": "", "fmLocation":"", "fmURL":""])
...
//        self.navigationController?.view.backgroundColor = .clear
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        return fmLanguageArry.count
    }
    
    func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        let str = fmLanguageArry[section]
        return str["fmLanguage"]
    }
...
//        cell.textLabel?.font = UIFont(name: "HelveticaNeue", size: CGFloat(18))
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "FMListViewCell") as! FMListViewCell
        cell.selectionStyle = .none
        
        let partDict = fmListArry[indexPath.row]
        cell.fmNameLabel.text = partDict["fmName"]
        cell.fmFrequencyLabel.text = partDict["fmFrequency"]
        cell.fmLocationLabel.text = partDict["fmLocation"]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let dictObj = self.fmListArry[indexPath.row]
        selectedLiveStreamURL = dictObj["fmURL"]!
        selectedStationName = dictObj["fmName"]!
